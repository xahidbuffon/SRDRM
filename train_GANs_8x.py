#!/usr/bin/env python
"""
# > Script for training 8x GAN-based SISR models on USR-248 data 
...
data_loader = dataLoaderUSR(DATA_PATH="/mnt/data1/ImageSR/USR-248/", SCALE=8)
...
while (step <= num_step):
    for i, (imgs_lr, imgs_hr) in enumerate(data_loader.load_batch(batch_size)):
        ...
        if (model_name.lower()=="srdrm-gan"): 
            # custom loss function for ReMu-GAN
