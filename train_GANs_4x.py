...
data_loader = dataLoaderUnISR(SCALE=4)
...
model_name = "remugan" # options: ["remugan", "srgan", "esrgan", "edsrgan"]
if model_name.lower() == "srgan":
    ...
    print ("Using default model: ReMu-GAN")
    from nets.REMUGAN import ReMuGAN_model
    gan_model = ReMuGAN_model(lr_shape, hr_shape, SCALE=4)
